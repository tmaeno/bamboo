...
async def populate_knowledge_interactive():
    ...
    if _confirm("Do you have task data?"):
        ...
        if use_panda:
            ...
            try:
                from bamboo.agents.helpers.deps import resolve_task_data
...
from bamboo.scripts.populate_knowledge import main as _populate_main
cli.add_command(_populate_main, "populate")
...
from bamboo.scripts.review_drafts import main as _review_drafts_main
cli.add_command(_review_drafts_main, "review-drafts")
...
from bamboo.scripts.derive_strategy import main as _derive_strategy_main
cli.add_command(_derive_strategy_main, "derive-strategy")
